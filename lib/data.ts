...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    projectIds: ['animes-cegal', 'vavahelper'],
  },
  {
    id: 'star-alice',
    name: 'Alice Sofia',
...
export const projects: Project[] = [
  {
    ...
    fullDescription:
      'Animes Cegal is part of the AnimeVision initiative, a project focused on accessible anime experiences. The stack combines a modern frontend with a robust API and supporting Python services to help deliver an accessible and scalable platform.',
    techStack: ['Angular', 'pnpm', 'C#', 'Python', 'ASP.NET Core 8', 'PostgreSQL'],
    techGroups: [
      { category: 'Main stack', items: ['Angular', 'pnpm', 'C#', 'Python'] },
      { category: 'API & database', items: ['ASP.NET Core 8', 'PostgreSQL'] },
    ],
  ...
  },
  {
    ...
    techStack: ['Next.js 16', 'TypeScript', 'React', 'Tailwind CSS v4', 'Lucide React', 'Sonner', 'Axios', 'Spring Boot', 'pnpm'],
    techGroups: [
      { category: 'Frontend', items: ['Next.js 16', 'React', 'TypeScript', 'Tailwind CSS v4'] },
      { category: 'Libraries', items: ['Lucide React', 'Sonner', 'Axios'] },
      { category: 'Backend & tooling', items: ['Spring Boot REST API', 'pnpm'] },
    ],
  ...
  },
  {
    ...
    techGroups: [
      { category: 'Web platform', items: ['Next.js', 'React', 'TypeScript', 'Tailwind CSS'] },
      { category: 'Context', items: ['Institutional website', 'Academic support', 'UFRJ partnership'] },
    ],
  ...
  },
  {
    ...
    techStack: ['Next.js', 'TypeScript', 'pnpm', 'Java 17', 'Spring Boot 3', 'Spring Security', 'JPA', 'PostgreSQL', 'JWT', 'Maven'],
    techGroups: [
      { category: 'Frontend', items: ['Next.js', 'TypeScript', 'pnpm'] },
      { category: 'Backend & frameworks', items: ['Java 17', 'Spring Boot 3', 'Spring Security', 'JPA'] },
